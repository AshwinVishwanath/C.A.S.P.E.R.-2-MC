// CASPER 2 Mission Control v2 — Design Tokens
// Three schemes × two modes × four accents.
//
// Scheme controls layout/density philosophy:
//   obsidian  — cinematic glass + display type, optional shader BG
//   terminal  — strict grid, hairlines, zero glow, max density
//   instrument — circular gauges, blueprint cross-grid, callouts
//   fusion    — obsidian glass + cinematic type + instrument cleanliness (default)
//
// Mode controls foreground/background:
//   dark   — obsidian black → mint accent default
//   light  — warm cream pearl → hot-orange accent default
//
// Accent overrides default per mode. Cyclable.
...
export function buildTheme(mode, accentName, scheme) {
  const accent = ACCENT_HUES[accentName] || ACCENT_HUES.mint;
  ...
  const light = {
    ...
    border:    "oklch(86% 0.010 75)",
    borderStrong: "oklch(74% 0.012 75)",
    gridLine:  "oklch(90% 0.008 75)",
    text:      "oklch(36% 0.012 75)",
    strong:    "oklch(18% 0.014 75)",
    muted:     "oklch(52% 0.012 75)",
    faint:     "oklch(72% 0.010 75)",
    accent:        accent.light,
    ...
    glassBg:    "oklch(99% 0.006 75 / 0.65)",
    shader: ["oklch(94% 0.012 75)", accent.light, "oklch(80% 0.020 60)"],
  };
