...
export default function CasperMC() {
  ...
  var tabs=[{id:"setup",label:"SETUP",icon:"⚙"},{id:"test",label:"TEST",icon:"⚡"},{id:"flight",label:"FLIGHT",icon:"▲"},{id:"tracking",label:"TRACK",icon:"◎"},...(import.meta.env.DEV?[{id:"lab",label:"LAB",icon:"◇"}]:[])];
          ...
          <div style={{flex:1,overflow:"auto",padding:14,position:"relative"}}>
            ...
            {tab==="setup"&&(
              <div style={{animation:"fadeUp 0.18s ease-out",maxWidth:1400,margin:"0 auto"}}>
                ...
                <DiagTab conn={fcConn}/>
                <FlightLogPanel conn={fcConn} theme={T}/>
            ...
            {/* ===== LAB TAB (dev-only design taster) ===== */}
            {tab==="lab"&&(
              <LabTab/>
            )}
